          ...
          <Grid container spacing={5}>
            <Grid item xs={12} md={6}>
              {memberDetail?.investmentId ? (
                <TextField
                  ...
                  fullWidth
                  defaultValue={memberDetail?.investmentId}
                  label='รหัส'
            ...
            <Grid item xs={12} md={6}>
              {memberDetail?.nationalId ? (
                <TextField
                  InputProps={{ readOnly: true }}
                  fullWidth
                  defaultValue={memberDetail?.nationalId}
            ...
            <Grid item xs={12} md={6}>
              {memberDetail?.nationalId ? (
                <TextField
                  InputProps={{ readOnly: true }}
                  fullWidth
                  defaultValue={memberDetail?.netTotalShareQuantity}
                  label='ยอดหุ้นทั้งหมด'
                />
              ) : (
                <Skeleton variant='rectangular' width={250} height={55} />
              )}
            ...
            <Grid item xs={12} md={6}>
              {memberDetail?.nationalId ? (
                <TextField
                  InputProps={{ readOnly: true }}
                  fullWidth
                  defaultValue={memberDetail?.netTotalShare}
                  label='ยอดเงินลงทุนทั้งหมด'
                />
              ) : (
                <Skeleton variant='rectangular' width={250} height={55} />
              )}
            ...
            <Grid item xs={12} md={6}>
              <TextField
                fullWidth
                InputProps={{ readOnly: true }}
                defaultValue={memberDetail?.shareQuantity}
                label='จำนวนหุ้น'
                type='number'
              />
            </Grid>
            <Grid item xs={12} md={6}>
              <TextField
                fullWidth
                InputProps={{ readOnly: true }}
                defaultValue={memberDetail?.valuePerShare}
                label='ราคาหุ้นต่อหน่วย'
              />
            </Grid>
            <Grid item xs={12} md={6}>
              <TextField
                fullWidth
                InputProps={{ readOnly: true }}
                defaultValue={memberDetail?.totalShare}
                label='จำนวนเงินลงทุนทั้งหมด'
              />
            ...
            <Grid item xs={12} md={6}>
              <FormControl fullWidth>
                ...
                <Select
                  label='ผลการพิจารณาอนุมัติ'
                  defaultValue='1'
                  {...register('investmentStatusId', { required: true })}
                >
                  <MenuItem key='1' value='1'>
                    อนุมัติ
                  </MenuItem>
