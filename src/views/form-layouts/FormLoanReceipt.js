  ...
  return (
    <Grid container spacing={2} sx={{ pl: 15, pr: 15 }}>
      ...
      <Grid item xs={12} sm={12} sx={{ display: 'flex', justifyContent: 'right' }}>
        <Typography>โรงเรียนดารุสสาลาม เลขที่ 7 ถ.เทศบาล 8</Typography>
      </Grid>
      <Grid item xs={12} sm={12} sx={{ display: 'flex', justifyContent: 'right' }}>
        <Typography>ต.ตันหยงมัส อ.ระแงะ จ.นราธิวาส 96130</Typography>
      </Grid>
      <Grid item xs={12} sm={12} sx={{ display: 'flex', justifyContent: 'right' }}>
        <Typography>
      ...
      <Grid item xs={12} sm={12} sx={{ display: 'flex', justifyContent: 'left' }}>
        <Typography variant='inset' sx={{ lineHeight: 2, justifyContent: 'justify' }} paragraph='true'>
          ...
          จ.{loanDetail?.province} รหัสไปรษณีย์ {loanDetail?.postCode} เป็นบุคลากร{loanDetail?.paymentDesc}{' '}
          มีความประสงค์ขอรับเงินสวัสดิการ กลุ่มสวัสดิการครูดารุสสาลามดังนี้
        </Typography>
      </Grid>
            ...
            <TableBody>
              <TableRow key={loanDetail?.loanTypeName}>
                <TableCell align='left' sx={{ border: '1px solid rgba(224, 224, 224, 1)' }}>
                  <Typography variant='body2'>{loanDetail?.loanTypeName}</Typography>
                </TableCell>
                <TableCell align='center' sx={{ border: '1px solid rgba(224, 224, 224, 1)' }}>
                  <Typography variant='body2'>{loanDetail?.loanAmount}</Typography>
                </TableCell>
                <TableCell align='center' sx={{ border: '1px solid rgba(224, 224, 224, 1)' }}>
              ...
              <TableRow>
                <TableCell align='left' sx={{ border: '1px solid rgba(224, 224, 224, 1)' }}>
                  <Typography>จำนวนเงิน ({THBText(loanDetail?.loanAmount)})</Typography>
                </TableCell>
                <TableCell align='center' sx={{ border: '1px solid rgba(224, 224, 224, 1)' }}>
