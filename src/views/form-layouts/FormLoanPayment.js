        ...
        <CardContent>
          <Grid container spacing={5}>
            <Grid item xs={12} md={6} lg={3}>
              {paymentSuggestionInfo?.loanId ? (
                <TextField
                  ...
                  fullWidth
                  defaultValue={paymentSuggestionInfo?.loanId}
                  label='รหัสสวัสดิการ'
                  {...register('loanId')}
                />
              ) : (
            ...
            <Grid item xs={12} md={6} lg={3}>
              {paymentSuggestionInfo?.refId ? (
                <TextField
                  InputProps={{ readOnly: true }}
                  fullWidth
                  defaultValue={paymentSuggestionInfo?.refId}
                  label='เลขที่สัญญา'
                />
              ) : (
                <Skeleton variant='rectangular' width={250} height={55} />
            ...
            <Grid item xs={12} md={6} lg={3}>
              {paymentSuggestionInfo?.memberName ? (
                <TextField
                  InputProps={{ readOnly: true }}
                  fullWidth
                  defaultValue={paymentSuggestionInfo?.memberName}
                  label='ชื่อสมาชิก'
                />
              ) : (
                <Skeleton variant='rectangular' width={250} height={55} />
            ...
            <Grid item xs={12} md={6} lg={3}>
              {paymentSuggestionInfo?.loanTypeName ? (
                <TextField
                  InputProps={{ readOnly: true }}
                  fullWidth
                  defaultValue={paymentSuggestionInfo?.loanTypeName}
            ...
            <Grid item xs={12} md={6} lg={3}>
              {paymentSuggestionInfo?.loanAmount ? (
                <TextField
                  InputProps={{ readOnly: true }}
                  fullWidth
                  defaultValue={paymentSuggestionInfo?.loanAmount}
            ...
            <Grid item xs={12} md={6} lg={3}>
              {paymentSuggestionInfo?.monthNo ? (
                <TextField
                  fullWidth
                  type='number'
                  defaultValue={paymentSuggestionInfo?.monthNo}
                  label='งวดที่'
                  {...register('monthNo')}
                />
              ) : (
            ...
            <Grid item xs={12} md={6} lg={3}>
              <TextField
                fullWidth
                defaultValue={moment(paymentSuggestionInfo?.loanPaymentMonth).format('YYYY-MM-DD')}
                label='เดือน'
                type='date'
                {...register('loanPaymentMonth')}
                InputLabelProps={{
                  shrink: true
                }}
              />
            ...
            <Grid item xs={12} md={6} lg={3}>
              {paymentSuggestionInfo?.totalLoanBalance ? (
                <TextField
                  ...
                  type='number'
                  InputProps={{ readOnly: true }}
                  defaultValue={paymentSuggestionInfo?.totalLoanBalance ?? 0}
                  label='ยอดคงเหลือ'
                  {...register('totalLoanBalance')}
                />
              ) : (
                <Skeleton variant='rectangular' width={250} height={55} />
              )}
            ...
            <Grid item xs={12} md={6} lg={3}>
              {paymentSuggestionInfo?.monthlyPayment ? (
                <TextField
                  fullWidth
                  type='number'
                  defaultValue={paymentSuggestionInfo?.monthlyPayment}
                  label='ยอดชำระ'
            ...
            <Grid item xs={12} md={6} lg={3}>
              <TextField
                ...
                type='text'
                InputProps={{ readOnly: true }}
                value={loanStatusName ?? 'ชำระรายเดือน'}
              ...
              {paymentSuggestionInfo?.paymentTypeId ? (
                <FormControl fullWidth>
                  ...
                  <Select
                    ...
                    defaultValue={paymentSuggestionInfo?.paymentTypeId ?? ''}
